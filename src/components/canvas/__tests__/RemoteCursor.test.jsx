...
jest.mock('react-konva', () => ({
  ...
  Arrow: ({ fill }) => <div data-testid="cursor-arrow" data-fill={fill} />,
...
describe('RemoteCursor', () => {
  it('renders without crashing with valid props', () => {
    ...
    expect(getByTestId('cursor-arrow')).toBeInTheDocument();
    expect(getByTestId('cursor-arrow').dataset.fill).toBe('#ff0000');
  ...
  it('renders with different colors and labels', () => {
    ...
    expect(getByTestId('cursor-arrow').dataset.fill).toBe('#00ff00');
